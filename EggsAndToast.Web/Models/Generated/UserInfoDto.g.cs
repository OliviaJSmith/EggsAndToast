...
{
    public partial class UserInfoParameter : GeneratedParameterDto<EggsAndToast.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(EggsAndToast.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override EggsAndToast.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new EggsAndToast.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<EggsAndToast.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(EggsAndToast.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
